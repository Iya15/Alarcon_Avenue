            ...
            <Container>
                <div className="py-12 lg:py-16">
                    <div className="grid grid-cols-2 gap-8 sm:grid-cols-2 lg:grid-cols-5">
                        ...
                        {columns.map((col) => (
                            <div key={col.heading}>
                                <h3 className="text-xs font-semibold uppercase tracking-widest text-ink-900">
                                    {col.heading}
                                </h3>
                ...
                <div className="flex flex-col items-center justify-between gap-3 border-t border-ink-100 py-6 sm:flex-row">
                    <p className="text-xs text-ink-400">
                        © {new Date().getFullYear()} Alarcon Avenue. All rights reserved.
                    </p>
                    <p className="text-xs text-ink-400">
