    ...
    return (
        <AdminLayout title={isEdit ? `Edit ${coupon.code}` : 'New Coupon'}>
            ...
            <div className="max-w-lg">
                <form onSubmit={submit} className="space-y-4 rounded-xl border border-ink-800 bg-ink-900 p-6">
                    {field('Code', 'code', { placeholder: 'SUMMER25' })}

                    <div>
                        <label className="mb-1 block text-xs font-medium text-ink-300">Discount type</label>
                        <select
