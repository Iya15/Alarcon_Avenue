                            ...
                            <tr key={u.id} className="hover:bg-ink-800/50">
                                ...
                                <td className="px-4 py-3">
                                    <div className="flex flex-wrap gap-1">
                                        {u.roles.map((r) => (
                                            <span key={r} className="rounded-full bg-ink-700 px-2 py-0.5 text-xs text-ink-200">{r}</span>
                                        ))}
                                    </div>
                                </td>
                                <td className="px-4 py-3">
                                    ...
                                    {!u.email_verified_at && <span className="ml-1 text-xs text-yellow-500">(unverified)</span>}
                                </td>
